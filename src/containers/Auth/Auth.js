...
class Auth extends Component {
  ...
  render() {
    ...
    let form = formElementsArray.map(formElement => (<Input key={formElement.id} elementType={formElement.config.elementType}
...
const mapDispatchToProps = dispatch => {
  return {
    onAuth: (email, password, isSigned) => dispatch(actions.auth(email, password, isSigned))
  }
}
